...
@csrf  
<div class="col-md-12">
    <div class="card" style="background: #F2F2F7; padding:20px">
    ...
    <a href="#" id = "addButton" data-bs-target="#addModal" data-bs-toggle="modal" class = "btn btn-success col-md-2">Add</a>
        <table id="table-checkout" class = "table" style = "margin-top: 10px">
            ...
            <tr>
              <td width = "3%"><a href="#" id = "deleteRow" data-harga ="'+subtotal+'"><img src="../symbols/trash.png" style="width:20px;height:20px;"></a></td>              <td>{{ $row->menu_id_menu }}</td>
              <td>{{ $row->Varian }}</td>
              <td>{{ $row->jumlah }}</td>
            </tr>
              @endforeach
        ...
        <div id="total_harga" class="total_harga" style="text-align: right; margin-top:50px;">
            ...
            <input type="text" class="" id="total" name="total" value="0" style="border:none; border-bottom:1px" readonly>
        </div>
        <div style="text-align: right; margin-top:10px">
            <button type ="button" data-bs-target="#payNow" data-bs-toggle="modal" class="btn btn-primary btn-pay" style="">Pay Now</button>
            <button type ="button" class="btn btn-primary btn-submit" style="">Save</button>
        </div>
    </div>
</div>
...
$(document).on('click', '.btn-submit', function(e){
    ...
    var total = document.getElementById("total").value;
    var jenis_order = document.getElementById("jenis_order").value;
    var jenis_pembayaran = null;
    var status_pembayaran = "Belum Lunas";
    var nama_menu =[];
    var qty =[];
    var varian =[];
    var subtotal =[];
